      ...
      <div class="row sidebar">
		<aside class="col-xs-12 col-sm-6 col-md-3 widget social">
		  ...
		  <div class="social-list">
			<a class="icon rounded icon-facebook" href="https://www.facebook.com/bitejava" target="_blank"><i class="fa fa-facebook" style="line-height: 40px"></i></a>
			<a class="icon rounded icon-twitter" href="#" target="_blank"><i class="fa fa-twitter" style="line-height: 40px"></i></a>
			<a class="icon rounded icon-google" href="https://plus.google.com/100470183845989306019" target="_blank"><i class="fa fa-google" style="line-height: 40px"></i></a>
			<a class="icon rounded icon-linkedin" href="#" target="_blank"><i class="fa fa-linkedin" style="line-height: 40px"></i></a>
		  </div>
